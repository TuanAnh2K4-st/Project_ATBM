    ...
    <div class="avatar">
        ...
        <nav>
            <ul>
                ...
                <li><a href="#discount" onclick="showSection('discount')"><i class="fa-sharp fa-solid fa-file"></i> Quản
                    lý mã giảm giá</a></li>
                <li><a href="#settings" onclick="showSection('settings')"><i class="fa fa-cogs"></i> Cài Đặt</a></li>
                <li><a href="#users" onclick="showSection('users')"><i class="fa-solid fa-user"></i> Tài khoản người
                    dùng</a></li>
...
<main class="content">
        ...
        <div class="container" style="background: #b3d4fc;box-shadow: none">
            ...
            <div class="product-list">
                ...
                <div class="product-list">
                    <div class="card">
                        <h3>Thêm sản phẩm</h3>
                        <form action="admin?action=add" method="post" enctype="multipart/form-data">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" id="productBrand" class="form-control" name="productBrand"
                                           required></div>

                                <label for="productStock" class="col-sm-2 col-form-label">Số lượng tồn kho:</label>
                                <div class="col-sm-2">
                                    <input type="number" id="productStock" class="form-control" name="productStock"
                                           required></div>
                    ...
                    <div class="card">
                        ...
                        <form action="admin?action=delete" method="post">
                            <div class="form-group row" style="display: flex; align-items: center;">
                                ...
                                <div class="col-sm-5">
                                    <input type="number" id="productToDelete" name="productId" class="form-control"
                                           required>
                                </div>
                                <div class="col-sm-3">
                                    <button type="submit" class="btn btn-danger" id="deleteProductButton">Xóa sản phẩm
                                    </button>
                                </div>
                            </div>
                        </form>
    ...
    <script>
        document.getElementById("deleteProductButton").addEventListener("click", function (event) {
